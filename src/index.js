...
var base = Rebase.createClass({
  apiKey: "AIzaSyCJRiTPi8LSxSvDSkIZ9oE1AgwlQOZwYBY",   // replace with your Firebase application's API key
  databaseURL: "https://yess-bb0af.firebaseio.com/", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  renderMainSection: function() {
    if (this.state.currentView === "map") {
      ...
      return (
        <div className= "sort row" className="Active">
